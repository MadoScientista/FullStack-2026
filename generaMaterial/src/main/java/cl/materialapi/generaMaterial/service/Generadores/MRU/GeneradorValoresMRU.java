...
import cl.materialapi.generaMaterial.model.enums.ContextoFisico;
import cl.materialapi.generaMaterial.model.enums.Dificultad;
import cl.materialapi.generaMaterial.model.enums.Conversion;
import cl.materialapi.generaMaterial.model.enums.VariableFisica;
import cl.materialapi.generaMaterial.utilidades.UtilidadVariables;
import lombok.Data;
...
public class GeneradorValoresMRU {
    ...
    private Map<String, Variable> variablesCalculadas = new HashMap<>();
    ...
    public Map<String, Variable> generarValores(){
    ...
    public Map<String, Variable> build(){
        variablesCalculadas.put("x", x);
        variablesCalculadas.put("x0", x0);
        variablesCalculadas.put("v", v);
        variablesCalculadas.put("t", t);
    ...
    private Map<String, Variable> calcularX0(){
        // x0 = x - v*t
    ...
    private Map<String, Variable> calcularX(){
        // x = x0 + v*t
    ...
    private Map<String, Variable> calcularV(){
        // v = (x-x0)/t
    ...
    private Map<String, Variable> calcularT(){
